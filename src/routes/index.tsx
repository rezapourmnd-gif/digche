...
const sections: Section[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "تهیه‌شده از ۲۲۰ گرم گوشت خالص، سرو با برنج ایرانی و گوجه کبابی",
        price: 730000,
  ...
  },
  {
    ...
    items: [
      {
        name: "سالاد سزار",
        desc: "کاهو رومی، سینه مرغ گریل، نان کروتون و سس سزار",
        price: 245000,
      ...
      {
        name: "سالاد یونانی",
        desc: "گوجه، خیار، فلفل دلمه، زیتون و پنیر فتا",
        price: 195000,
